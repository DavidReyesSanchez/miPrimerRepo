/*Pedir al usuario una cadena de caracteres, reservar 
memoria con malloc, almacenarlo en la memoria dinamica, 
posteriormente utilizar free para liberar espacio
en la memoria dinamica utilizado.    */
